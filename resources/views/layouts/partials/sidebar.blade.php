<div class="fixed left-0 top-0 w-64 h-full bg-white py-10 z-50 sidebar-menu transition-transform" style="border-right: 1px solid #cfcece">
    ...
    <ul class="mt-3 bg-white h-full">
        <li class="group pl-6 relative">
            <a href="{{ route('dashboard') }}" class="flex py-3 items-center hover:bg-primary-700 before:absolute before:rounded-r-2xl before:content-[''] before:w-[3px] before:h-[48px] before:top-0 {{ Route::is('dashboard') ? 'bg-primary-700' : 'font-normal' }}">
                <span class="pl-4 flex items-center text-paragraph">
                    ...
                    <span class="text-paragraph ml-2">Dashboard</span>
                </span>
            </a>
        </li>
