    ...
    <ul class="mt-4 bg-primary-500 h-full">
        ...
        @foreach (Helper::getAllMenus() as $menu)
            ...
            @if (Helper::roleWiseMenuPermission($menu->id))
                <li class="group py-4 px-5 relative">
                    <span
                        class="flex items-center before:absolute before:rounded-l-xl before:content-[''] before:w-[4px] before:h-full before:bg-primary-400 before:top-0 before:right-0">
                        {!! $menu->icon !!}
            ...
            <ul class="pl-6 mt-4 hidden group-[.selected]:block">
                <li class="mb-4 flex">
                    ...
                    <a href="{{ route('admin.user.index') }}"
                        class="flex font-semibold items-center rounded-md group-[.active]:text-green-800 group-[.selected]:text-green-800">
                        <i class="ri-home-2-line mr-3 text-lg"></i>
                ...
                <li class="mb-4 flex">
                    ...
                    <a href="{{ route('dashboard.menu.index') }}"
                        class="pl-3 text-gray-900 text-base font-inter font-medium flex items-center hover:text-[#f84525]">{{ __('Menus') }}</a>
                </li>
                <li class="mb-4 flex">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{ route('dashboard.role.index') }}"
                        class="pl-3 text-gray-900 text-base font-inter font-medium flex items-center hover:text-[#f84525]">{{ __('Role') }}</a>
                </li>
