        ...
        <li class="group py-4 px-5 relative">
            ...
            <ul class="pl-6 mt-4 hidden group-[.selected]:block">
                <li class="mb-4 flex">
                    ...
                    <a href="{{ route('admin.event.create') }}" class="pl-3 text-gray-900 text-base font-inter font-medium flex items-center hover:text-[#f84525]">Create
                        Events
                    </a>
                </li>
                <li class="mb-4 flex">
        ...
        <li class="group py-4 px-5 relative">
            ...
            <ul class="pl-6 mt-4 hidden group-[.selected]:block">
                <li class="mb-4 flex">
                    ...
                    <a href="{{ route('admin.user.index') }}" class="flex font-semibold items-center rounded-md group-[.active]:text-green-800 group-[.selected]:text-green-800">
                        <i class="ri-home-2-line mr-3 text-lg"></i>
