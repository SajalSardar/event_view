        ...
        <li class="mb-1 group pb-5 px-5">
            ...
            <ul class="pl-6 mt-4 hidden group-[.selected]:block">
                <li class="mb-4 flex">
                    ...
                    <a href="#" class="pl-3 text-gray-900 text-sm flex items-center hover:text-[#f84525]">Create Events</a>
                </li>
                <li class="mb-4 flex">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 2V4M6 2V4" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <a href="" class="pl-3 text-gray-900 text-sm flex items-center hover:text-[#f84525]">Manage Events</a>
                </li>
            </ul>
        </li>
        ...
        <li class="mb-1 group pb-5 px-5">
            ...
            <ul class="pl-6 mt-4 hidden group-[.selected]:block">
                ...
                <li class="mb-4 flex">
                    ...
                    <a href="" class="pl-3 text-gray-900 text-sm flex items-center hover:text-[#f84525]">System Seetings</a>
                </li>
            </ul>
        </li>
    </ul>
