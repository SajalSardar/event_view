<div class="fixed left-0 top-0 w-64 h-full bg-white py-10 z-50 sidebar-menu transition-transform"
    ...
    <ul class="mt-4 bg-primary-500 h-full">
        <li class="mb-1 group flex py-5 px-5">
        ...
        <li class="mb-1 group pb-5 px-5">
            <svg class="inline-block" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <path d="M11 13H16M8 13H8.00898M13 17H8M16 17H15.991" stroke="#6D4DFF" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" />
                <path d="M18 2V4M6 2V4" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path
                    d="M2.5 12.2432C2.5 7.88594 2.5 5.70728 3.75212 4.35364C5.00424 3 7.01949 3 11.05 3H12.95C16.9805 3 18.9958 3 20.2479 4.35364C21.5 5.70728 21.5 7.88594 21.5 12.2432V12.7568C21.5 17.1141 21.5 19.2927 20.2479 20.6464C18.9958 22 16.9805 22 12.95 22H11.05C7.01949 22 5.00424 22 3.75212 20.6464C2.5 19.2927 2.5 17.1141 2.5 12.7568V12.2432Z"
                    stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M3 8H21" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>

            <a href="#" style="display: inline"
                class="flex font-semibold items-center text-gray-900 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white sidebar-dropdown-toggle">
                <i class='bx bx-user mr-3 text-lg'></i>
                <span class="text-sm">Events</span>
                <i class="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
            </a>
            <ul class="pl-6 mt-4 hidden group-[.selected]:block">
                <li class="mb-4 flex">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 2V4M6 2V4" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M3 8H21" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path
                            d="M2.5 12.2432C2.5 7.88594 2.5 5.70728 3.75212 4.35364C5.00424 3 7.01949 3 11.05 3H12.95C16.9805 3 18.9958 3 20.2479 4.35364C21.5 5.70728 21.5 7.88594 21.5 12.2432V12.7568C21.5 17.1141 21.5 19.2927 20.2479 20.6464C18.9958 22 16.9805 22 12.95 22H11.05C7.01949 22 5.00424 22 3.75212 20.6464C2.5 19.2927 2.5 17.1141 2.5 12.7568V12.2432Z"
                            stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                            d="M12 17.5V18.5M12 17.5C11.1324 17.5 10.368 17.0581 9.91974 16.387M12 17.5C12.8676 17.5 13.632 17.0581 14.0803 16.387M9.91974 16.387L9.00032 17M9.91974 16.387C9.65459 15.9901 9.5 15.5131 9.5 15C9.5 14.4869 9.65455 14.01 9.91964 13.6131M14.0803 16.387L14.9997 17M14.0803 16.387C14.3454 15.9901 14.5 15.5131 14.5 15C14.5 14.4869 14.3454 14.01 14.0804 13.6131M12 12.5C12.8677 12.5 13.6321 12.942 14.0804 13.6131M12 12.5C11.1323 12.5 10.3679 12.942 9.91964 13.6131M12 12.5V11.5M14.0804 13.6131L15 13M9.91964 13.6131L9 13"
        ...
        <li class="mb-1 group flex py-5 px-5">
            ...
            <a href="{{ route('dashboard.module.create') }}"
                class="flex font-semibold items-center text-gray-900 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                <i class="ri-home-2-line mr-3 text-lg"></i>
                ...
                <li class="mb-4 flex">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <path
                            ...
                            stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round" />
                        <path d="M11 15H13" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                    ...
                    <a href="#"
                        class="pl-3 text-gray-900 text-sm flex items-center hover:text-[#f84525]">Platform Seetings</a>
                </li>
                <li class="mb-4 flex">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                            d="M18 19.7143V21M18 19.7143C16.8432 19.7143 15.8241 19.1461 15.2263 18.2833M18 19.7143C19.1568 19.7143 20.1759 19.1461 20.7737 18.2833M15.2263 18.2833L14.0004 19.0714M15.2263 18.2833C14.8728 17.773 14.6667 17.1597 14.6667 16.5C14.6667 15.8403 14.8727 15.2271 15.2262 14.7169M20.7737 18.2833L21.9996 19.0714M20.7737 18.2833C21.1272 17.773 21.3333 17.1597 21.3333 16.5C21.3333 15.8403 21.1273 15.2271 20.7738 14.7169M18 13.2857C19.1569 13.2857 20.1761 13.854 20.7738 14.7169M18 13.2857C16.8431 13.2857 15.8239 13.854 15.2262 14.7169M18 13.2857V12M20.7738 14.7169L22 13.9286M15.2262 14.7169L14 13.9286"
                            stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round" />
                        <path d="M9.5 2V4" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M14.5 2V4" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M9.5 20V22" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M4 9.5H2" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M4 14.5H2" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M22 9.5H20" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M12 8H8" stroke="#6D4DFF" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
