<div class="navbar sticky border border-b-slate-300">
    <div class="navbar-wrapper">
        ...
        <div class="search-input">
            <form class="w-full">
                <x-forms.text-input-icon type="text" placeholder="Search events by name and locations" dir="end" style="border:1px solid #dad7d7 !important">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="notification">
            <div class="relative cursor-pointer mr-2 toggle-notification-button">
                <svg width="24" height="24" class="sm:w-4 sm:h-4 md:w-5 md:h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="md:w-5 md:h-5 sm:w-4 sm:h-4 bg-red-500 rounded-full text-center align-middle text-white text-xs absolute -top-2 -end-2">
                    10
        ...
        <div class="profile relative">
            <div class="toggle-menu-button flex justify-center items-center">
                <img src="{{ asset('assets/images/profile.png') }}" alt="profile" class="ml-3 sm:w-2/4 sm:h-2/4 md:w-full md:h-full">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 9L12 15L18 9" stroke="#333333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </div>
            <div class="toggle-menu absolute p-3 shadow-lg w-[200px] rounded bg-white sm:right-12" style="top: 70px;display:none">
                <ul>
                    <li class="py-2">
