    ...
    <div class="navbar-wrapper">
        ...
        <div class="notification">
            <div class="relative cursor-pointer mr-2 toggle-notification-button">
                <svg width="24" height="24" class="sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <div
                    class="md:w-5 md:h-5 w-5 h-5 sm:w-4 sm:h-4 bg-red-500 rounded-full text-center align-middle text-white text-xs absolute -top-2 -end-2">
                    10
                    <div class="absolute top-0 start-0 rounded-full -z-10 animate-ping bg-red-400 w-full h-full"></div>
                </div>
        ...
        <div class="profile">
            ...
            <div class="toggle-menu absolute p-3 shadow-lg w-full rounded bg-white sm:-right-5"
