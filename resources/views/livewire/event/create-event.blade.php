                ...
                <div class="border border-base-500 p-6 rounded">
                    ...
                    <div class="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 sm:gap-1 md:gap-2">
                        <div class="w-full">
                            ...
                            <x-forms.text-input type="text" wire:model.live='title' placeholder="Event title" />
                    ...
                    <div class="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 sm:gap-1 md:gap-2 mt-2">
                        <div class="w-full">
                            ...
                            <x-forms.text-input type="text" wire:model.live='description' placeholder="Event description" />
                    ...
                    <div class="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 sm:gap-1 md:gap-2">
                        <div class="pt-2 w-full">
                            <x-forms.label for="image" required='yes'>
                                {{ __('Image') }}
                            </x-forms.label>
                            <div class="upload-container">
                                <input wire:model="image" type="file" id="file-input" accept="image/*" hidden />
                            </div>
                    ...
                    <div class="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 sm:gap-1 md:gap-2">
                        <div class="pt-2 w-full">
                            <x-forms.label for="organizer" required='yes'>
                                {{ __('Organizer') }}
                            </x-forms.label>
                            <x-forms.select-input wire:model.live="organizer">
                    ...
                    <div class="grid lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 sm:gap-1 md:gap-2">
                        <div class="pt-2 w-full">
                            <x-forms.label for="category" required='yes'>
                                {{ __('Category') }}
                            </x-forms.label>
                            <x-forms.select-input wire:model.live="category">
